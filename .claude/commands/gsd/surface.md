...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/.gsd-surface.json`
(sibling to `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/skills`).
...
`/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/.gsd-surface.json`
Install profile marker: `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/.gsd-profile`
Skill dirs: `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/skills/gsd-*/`
Engine module: `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
