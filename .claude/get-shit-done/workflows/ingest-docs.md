...
```bash
INIT=$(node "/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
