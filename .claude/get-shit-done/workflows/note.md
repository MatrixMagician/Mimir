...
- **Global scope**: `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/notes/`)
...
2. Glob `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/notes/` — works in any directory
