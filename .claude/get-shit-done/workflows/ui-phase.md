...
```markdown
Read /home/oliverh/repos/github/MatrixMagician/Mimir/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/oliverh/repos/github/MatrixMagician/Mimir/.claude/agents/gsd-ui-checker.md for instructions.
