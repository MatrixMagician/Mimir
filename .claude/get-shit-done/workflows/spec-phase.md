...
```bash
INIT=$(node "/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/templates/spec.md.
