...
- Usage: Reference from command with `@/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/oliverh/repos/github/MatrixMagician/Mimir/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/oliverh/repos/github/MatrixMagician/Mimir/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
