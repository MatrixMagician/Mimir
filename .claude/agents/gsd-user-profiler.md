...
<reference>
@/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/references/user-profiling.md` to load:
