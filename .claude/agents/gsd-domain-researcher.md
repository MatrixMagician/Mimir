...
<required_reading>
Read `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
