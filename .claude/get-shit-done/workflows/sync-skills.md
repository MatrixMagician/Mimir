...
INSTALL_JS_GLOBAL="/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
