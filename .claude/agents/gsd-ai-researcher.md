...
<required_reading>
Read `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
