...
| 02-02-T2 | 02 | 2 | SUP-01 | T-02-04,T-02-05 | inline-ignored finding doesn't flip exit; no data race | integration (CLI) | `go test ./cmd/mimir/ -run 'TestInlineIgnore\|TestVerboseHint' -race` | ❌ Wave 0 (scan_test additions) | ⬜ pending |
...
| 02-04-T2 | 04 | 4 | SUP-03 | T-02-12,T-02-13,T-02-14 | all-baselined exits 0; --show-suppressed no exit flip; OUT-02 preserved | integration (CLI) | `go test ./cmd/mimir/ -run 'TestBaseline\|TestShowSuppressed\|TestSuppressedExitCode' -race` | ❌ Wave 0 (scan_test + output_test) | ⬜ pending |
...
- [ ] `internal/output/output_test.go` additions — D-11 summary, D-12 omitempty — Plan 04 Task 2
- [ ] `cmd/mimir/scan_test.go` additions — baseline/show-suppressed/verbose-hint/exit-code via os/exec binary — Plans 02 & 04
