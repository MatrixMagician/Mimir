...
The keys live in `.claude/settings.json` (project) or `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/settings.json` (global) — **not** in `.planning/config.json`:
