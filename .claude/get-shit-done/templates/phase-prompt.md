...
<!-- For checkpoint task examples and patterns, see @/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/references/checkpoints.md -->
...
See `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/oliverh/repos/github/MatrixMagician/Mimir/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
